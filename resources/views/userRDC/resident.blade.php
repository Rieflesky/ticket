    ...
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text">Per Person RM 7.00</p>
                        <form action="{{ route('cartStore') }}" method="POST">
                            @csrf
                            <input type="hidden" name="ticket_type" value="adult">
                            <label for="adultQuantity">Quantity:</label>
                            <input type="number" id="adultQuantity" name="quantity" min="1" value="1"
                                required><br>
            ...
            <div class="col-md-6">
                <div class="card text-center">
                    <div class="card-body">
                        <h3 class="card-title">Children (5-17 yrs)</h3>
                        <p class="card-text">Per Person RM 3.00</p>
                        <form action="{{ route('cartStore') }}" method="POST">
                            @csrf
                            <input type="hidden" name="ticket_type" value="children">
                            <label for="childrenQuantity">Quantity:</label>
                            <input type="number" id="childrenQuantity" name="quantity" min="1" value="1"
                                required><br>
                            <button type="submit" class="btn btn-orange" data-toggle="modal" data-target="#cartModal">
                                <i class="fas fa-check"></i> Add to Cart
                            </button>
